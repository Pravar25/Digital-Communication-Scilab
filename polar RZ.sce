//Program Ti t l e : Codes − 1( po l a r RZ)
clear ;
close ;
clc ;
clf ;
...
for i =1:length (x)
t=[z:z+1]; // Se t o f x c o r d i n a t e s f o r c u r r e n t b i t d u r a t i o n
subplot (2 ,1 ,1)
a= gca ();
...
//title ( ’NRZ’ )
if(x(i)==0)
plot (t,-1) // Pl o t 0 f o r c u r r e n t b i t d u r a t i o n
else
